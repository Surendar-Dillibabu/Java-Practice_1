...
public class FindKthLargestInteger {
  ...
  public static void main(String[] args) throws IOException {
    try (BufferedReader br = new BufferedReader(new InputStreamReader(System.in))) {
      ...
      System.out.println("Please enter the kth element to find the largest integer");
      int kthNum = Integer.parseInt(br.readLine());

      FindKthLargestInteger obj = new FindKthLargestInteger();
      ...
      System.out.println("Largest integer of kth is :" + (numArr[(kthNum - 1)]));
    }
  }
