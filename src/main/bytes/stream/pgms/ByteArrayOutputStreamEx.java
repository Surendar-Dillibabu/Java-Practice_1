...
public class ByteArrayOutputStreamEx {
  ...
  public static void main(String[] args) throws FileNotFoundException, IOException {
    try (FileOutputStream fos1 = new FileOutputStream("G:\\Photon workspace\\Java-projects\\Practice_1\\bos.ex1");
        FileOutputStream fos2 = new FileOutputStream("G:\\Photon workspace\\Java-projects\\Practice_1\\bos.ex2");
