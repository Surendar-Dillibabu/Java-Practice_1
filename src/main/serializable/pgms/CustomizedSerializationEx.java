...
public class CustomizedSerializationEx {
  ...
  public static void main(String[] args) throws IOException, ClassNotFoundException {
    ...
    try (ObjectOutputStream oos = new ObjectOutputStream(
        new FileOutputStream("G:\\Photon workspace\\Java-projects\\Practice_1\\customized-ser-ex.ser"))) {
      oos.writeObject(userDetails1);
      System.out.println("Serialization completed");
    }

    try (ObjectInputStream oos = new ObjectInputStream(
        new FileInputStream("G:\\Photon workspace\\Java-projects\\Practice_1\\customized-ser-ex.ser"))) {
